            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50">
                        ...
                        <th class="py-5 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">Judul Informasi</th>
                        <th class="py-5 px-8 text-[11px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">Tanggal Dibuat</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-blue-50/50 transition duration-150 group">
                        ...
                        <td class="py-5 px-8">
                            <div class="font-bold text-gray-800 text-base group-hover:text-blue-700 transition">{{ $d->judul }}</div>
                            <div class="text-xs text-gray-500 italic mt-1">{{ $d->kategori }}</div>
                        </td>
                        <td class="py-5 px-8">
                            <span class="inline-flex items-center bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-bold">{{ $d->created_at->translatedFormat('d F Y') }}</span>
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="py-12 text-center text-gray-400 font-bold italic">Belum ada informasi pada kategori ini.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
