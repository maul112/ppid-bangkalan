    ...
    <div class="space-y-8">
        ...
        <div class="flex justify-between items-center bg-white p-4 rounded-[2rem] border border-gray-100 shadow-sm">
            <div class="flex items-center gap-3 ml-4">
                ...
                <span class="text-sm font-black text-gray-400 uppercase tracking-widest">Daftar Banner Aktif</span>
            </div>

            <a href="{{ route('admin.banner.create') }}" class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-2xl text-sm font-black shadow-lg shadow-red-100 transition flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
