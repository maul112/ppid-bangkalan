<x-admin-panel-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center bg-white p-4 rounded-[2rem] border border-gray-100 shadow-sm">
            ...
            <a href="{{ route('admin.berita.create') }}" class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-2xl text-sm font-black shadow-lg shadow-red-100 transition flex items-center gap-2">
