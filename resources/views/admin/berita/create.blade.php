<x-admin-panel-layout>
    <x-slot name="header">Tulis Berita Baru</x-slot>
            ...
            <div class="p-8 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 font-bold uppercase tracking-widest">Publikasikan Informasi Terbaru</p>
                    </div>
                </div>
                    ...
                    <div class="relative group">
                        ...
                        <label for="gambar" class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-100 rounded-[2rem] bg-gray-50 hover:bg-white hover:border-blue-400 transition-all cursor-pointer">
                            <div class="flex flex-col items-center py-6">
                                ...
                                <p id="file-label" class="text-sm text-gray-400 font-bold uppercase tracking-widest">Pilih Gambar Cover</p>
