<x-admin-panel-layout>
    <x-slot name="header">Tambah Pejabat PPID</x-slot>
            ...
            <form action="{{ route('admin.pejabat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: Dr. H. Fulan, M.Si" required>
                        @error('nama') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Jabatan Keterangan</label>
                        <input type="text" name="jabatan_keterangan" value="{{ old('jabatan_keterangan') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: Asisten Pemerintahan" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="instansi" value="{{ old('instansi') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: Sekretariat Daerah">
                    </div>

                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">NIP</label>
                        <input type="text" name="nip" value="{{ old('nip') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: 198001012005011001">
                    </div>

                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Pangkat</label>
                        <input type="text" name="pangkat" value="{{ old('pangkat') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: Pembina Utama Muda">
                    </div>

                    <div>
                        <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Golongan</label>
                        <input type="text" name="golongan" value="{{ old('golongan') }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-4 py-3" placeholder="Contoh: IV/c">
                    </div>
