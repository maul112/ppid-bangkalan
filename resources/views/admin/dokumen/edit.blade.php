<x-admin-panel-layout title="Edit Dokumen Publik">
    ...
    <div class="max-w-4xl mx-auto pb-12">
        {{-- Back Button --}}
        <div class="mb-6">
            <a href="{{ route('admin.dokumen.index') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-yellow-600 font-bold transition-all group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <select name="kategori" class="w-full border-none bg-gray-50 rounded-2xl px-6 py-4 focus:ring-2 focus:ring-yellow-500 shadow-inner text-gray-700 font-bold transition-all" required>
                                ...
                                <option value="SOP" {{ old('kategori', $dokumen->kategori) == 'SOP' ? 'selected' : '' }}>SOP</option>
                                <option value="Dasar Hukum" {{ old('kategori', $dokumen->kategori) == 'Dasar Hukum' ? 'selected' : '' }}>Dasar Hukum</option>
                            </select>
