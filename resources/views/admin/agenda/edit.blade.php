<x-admin-panel-layout>
    ...
    <div class="w-full pb-12">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 md:p-10">
            <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', $agenda->tanggal) }}" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-5 py-4 font-medium" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="waktu" value="{{ old('waktu', $agenda->waktu) }}" placeholder="Misal: 09.00 s/d Selesai" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-5 py-4 font-medium">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="judul" value="{{ old('judul', $agenda->judul) }}" placeholder="Contoh: Rapat Paripurna DPRD" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-5 py-4 font-medium" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="lokasi" value="{{ old('lokasi', $agenda->lokasi) }}" placeholder="Misal: Pendopo Agung Kabupaten" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-5 py-4 font-medium" required>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="dibuat_oleh" value="{{ old('dibuat_oleh', $agenda->dibuat_oleh) }}" placeholder="Nama Instansi Pembuat" class="w-full bg-gray-50 border border-gray-200 text-gray-800 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all px-5 py-4 font-medium" required>
