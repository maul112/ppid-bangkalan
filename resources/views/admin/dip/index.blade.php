    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-[2rem] border border-gray-100 shadow-sm">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mr-2">
                <form action="{{ route('admin.dip.index') }}" method="GET" class="w-full sm:w-auto">
                    ...
                    <tr class="hover:bg-gray-50/80 transition-all">
                        <td class="px-8 py-5">
                            @php
                                $color = match($d->kategori) {
                                    ...
                                    'Informasi Dikecualikan' => 'bg-red-100 text-red-600',
                        ...
                        <td class="px-8 py-5">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('admin.dip.edit', $d->id) }}" class="w-10 h-10 flex items-center justify-center bg-blue-50 text-blue-500 rounded-xl hover:bg-blue-600 hover:text-white transition-all">
